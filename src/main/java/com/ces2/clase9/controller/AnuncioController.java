...
import com.ces2.clase9.model.Anuncio;
import com.ces2.clase9.model.Autor;
import com.ces2.clase9.model.Comentario;
import com.ces2.clase9.model.Estado;
import com.ces2.clase9.model.Evento;
import com.ces2.clase9.model.Tipo;
import com.ces2.clase9.repository.AnuncioRepositorio;
import com.ces2.clase9.repository.AutorRepositorio;
import com.ces2.clase9.repository.EventoRepositorio;
...
public class AnuncioController {
		...
		public String ingresarAnuncio(
			...
			AggregateReference<Autor,Integer> autorAggregate = AggregateReference.to(
					autores.save(autor).getId()
					);
...
//			System.out.println(minuto);
			...
			Anuncio anuncio = new Anuncio(titulo,contenido,localdate,autorAggregate);
		...
		public String nuevoComentario(
			...
			Comentario comentario = new Comentario(name,content,fecha);
...
//			System.out.println(published);
		...
		public String ingresarEvento(Model model,
			...
			evento.setEstado(Estado.valueOf(estado));
			evento.setTipo(Tipo.valueOf(tipo));
			evento.setDatecreated(fecha);
